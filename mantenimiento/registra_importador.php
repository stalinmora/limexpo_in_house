...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="ingresa_importador" class="mantenimiento">
				...
				<div id ="detalle_importador">
					...
					<table  width="100%">
                       ...
                       <tr >
                        	...
                        	<td bgcolor="#3B7DA0" colspan="4" ><img bgcolor="#3B7DA0"  src="../images/cliente.png" width="35" height="35" />  <span style="font-size: 16; font-weight: bold; color: #999;">&nbsp;                     <span id="TituloMantenimiento" >Registro Importador</span></span></td>
                      </tr>
							<td widith="20%"><span class="etiqueta">Codigo:</span></td>
							<td width="30%">
							<input type="number" style="text-align:center" class="texto" name="codigo_importador" id="codigo_importador" value="" readonly >
							</input></td>
							<td width="12%" ></td>
							<td align="right"><div id="botones_mantenimiento" align="right" >
						...
						<tr>
							<td><span class="etiqueta">Tipo de Persona:</span></td>
							<td> 
						...
						<tr>
							...
							<td>
							<span class="obliga">*</span>
							<input type="text"  name="O_razon_social_importador" class="texto" id="razon_social_importador "  onFocus="entroEnFoco(this)" onBlur="revisarObligatorio(this); revisarLongitud2(this, 250)" tabindex="3" value ="">
							</input></td>
							<td><span class="etiqueta">Ciudad:</span></td>
							<td>
							<span class="obliga">*</span>
							<input type="text" name="O_ciudad_importador" class="texto" id="ciudad_importador" onFocus="entroEnFoco(this)" onBlur="revisarObligatorio(this); revisarLongitud2(this, 100)" tabindex="4" value="" >
							</input></td>
						</tr>
						<tr>
							...
							<td>
							<span class="obliga">*</span>
							<input type="text" name="identificacion" class="texto" id="identificacion" onFocus="entroEnFoco(this)" onBlur="ValidaIdentificacion2(this, 17)" tabindex="6" value="" />
							</td>
						</tr>
					</table >
				</div>
					...
					<div id ="datos_domicilio"  tabindex="7">
						<table width="100%">
							<tr>
								...
								<td>
								<span class="obliga">*</span>
								<input type="text" name="O_email_importador" class="texto" id="email_importador" value="" onFocus="entroEnFoco(this)" onBlur="revisarObligatorio(this); revisarLongitud2(this, 250); revisarCorreo(this)" tabindex="8" >
								</input></td>
							...
							<tr>
								...
								<td>
								<span class="obliga">*</span>
								<input type="text" name="O_telefono_importador" class="texto" id="telefono_importador" onFocus="entroEnFoco(this)" onBlur="revisarObligatorio(this); revisarLongitud2(this, 25)" tabindex="9" value="">
								</input></td>
								<td width="50%" valign="top" rowspan="2">								
								    <textarea   style="width:100%"   name="O_direccion_domicilio_importador" id="direccion_domicilio_importador" class="textarea" class="texto" rows="2" onFocus="entroEnFoco(this)" onBlur="revisarObligatorio(this); revisarLongitud2(this, 255)" tabindex="11" > </textarea>
								    </td>
							</tr>
							<tr>
								...
								<td>
								<span class="obliga">*</span>
								<input type="text" name="O_celular_importador" class="texto" id="celular_importador" onFocus="entroEnFoco(this)" onBlur="revisarObligatorio(this); revisarLongitud2(this, 25)" tabindex="10" value="">
								</input></td>
							</tr>
						</table>
					</div>
					<div id ="datos_trabajo">
						<table width="100%">
							...
							<tr>
								...
								<input type="text" name="email_trabajo_importador" class="texto" id="email_importador" onFocus="entroEnFoco(this)" onBlur="revisarLongitud2(this, 250); revisarCorreo(this)" tabindex="14" value="">
								</input></td>
							...
							<tr>
								...
								<input type="text" name="telefono_trabajo_importador" class="texto" id="telefono_trabajo_importador" onFocus="entroEnFoco(this)" onBlur="revisarLongitud2(this, 25)" tabindex="15" value="" >
								</input></td>
								<td>
								<input  type="text"class="cajatexto" name="direccion_trabajo_importador" id="direccion_trabajo_importador" onFocus="entroEnFoco(this)" onBlur="revisarLongitud2(this, 255)"  tabindex="16" value="">
								</input></td>
							</tr>
         ...
         <span  class="obliga">Los campos con (*) son de ingreso obligatorios </span>
	</body>
</html>
